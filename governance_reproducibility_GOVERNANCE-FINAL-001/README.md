# Reproduzierbarkeits-Paket für GOVERNANCE-FINAL-001

Dieses Paket enthält alle notwendigen Informationen zur exakten Reproduktion
des Builds für Feature-Spec `GOVERNANCE-FINAL-001`.

## Inhalt

- `reproducibility_manifest_GOVERNANCE-FINAL-001.json`: Vollständiges Reproduzierbarkeits-Manifest
- `requirements-lock-GOVERNANCE-FINAL-001.json`: Exakte Dependency-Versionen
...
manager = SupplyChainManager("GOVERNANCE-FINAL-001")
results = manager.verify_reproducibility(
    "reproducibility_manifest_GOVERNANCE-FINAL-001.json",
